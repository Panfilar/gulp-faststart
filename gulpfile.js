...
gulp.task('cssminify', ['less'], function () {
...
gulp.task('watch', ['browser-sync', 'css-libs', 'cssminify', 'scripts'], function () {
...
gulp.task('build', ['clean', 'img', 'cssminify','less', 'scripts'], function () {
